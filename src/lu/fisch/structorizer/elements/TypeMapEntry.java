...
//		}
	 ...
	 * 
	 * @param trueInCaseOfDoubt - specifies if a dubious (ambivalent or unspecified)
	 *     type is to be regarded as a (potential) numeric type or the contrary.
	 * @return {@code true} iff the type is definitely a canonical numeric type or
	 *     (partially) unknown but tolerated according to {@code trueInCaseOfDoubt}.
	 */
	public boolean isNumeric(boolean trueInCaseOfDoubt)
	{
		...
		return CANONICAL_NUMERIC_TYPES.contains(canonicalType);
	}

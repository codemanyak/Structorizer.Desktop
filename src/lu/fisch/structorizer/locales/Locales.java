...
/**
 * Fundamental localization manager (for Structorizer), holds the locales, registers GUI
 * components that want localization, and performs translations. Singleton class.
 * @author robertfisch
 */
